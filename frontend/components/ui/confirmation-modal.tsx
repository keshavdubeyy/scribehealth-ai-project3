...
export function ConfirmationModal({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-[400px] p-0 overflow-hidden border border-border shadow-2xl rounded-3xl">
        <div className="p-8 space-y-6">
          <div className="flex flex-col items-center text-center gap-4">
            ...
            <div className="space-y-2">
              ...
              <DialogDescription className="text-xs font-medium text-muted-foreground uppercase tracking-widest leading-relaxed px-4">
                {description}
              </DialogDescription>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <Button
              onClick={onClose}
              variant="ghost"
              className="w-full h-12 rounded-2xl font-bold uppercase tracking-widest text-[10px] text-muted-foreground hover:text-foreground hover:bg-muted transition-all"
            >
              Cancel
            </Button>
          </div>
